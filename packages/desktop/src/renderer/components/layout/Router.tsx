    ...
    <HashRouter>
      <Routes>
        ...
        <Route element={<ProtectedLayout layout={layout} />}>
          ...
          <Route
            path='/settings/webui'
            element={MULTI_USER_ENABLED ? withRouteFallback(WebuiSettings) : <Navigate to='/settings/model' replace />}
          />
          <Route
            path='/settings/client'
            element={MULTI_USER_ENABLED ? withRouteFallback(ClientSettings) : <Navigate to='/settings/model' replace />}
          />
          <Route
            path='/settings/users'
            element={
